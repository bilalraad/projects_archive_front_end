...
import 'view/project/edit_project/edit_project.dart' as _i7;
import 'view/project/project_details/project_details.dart' as _i6;
...
class AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    EditProjectRoute.name: (routeData) {
      ...
      return _i8.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i7.EditProjectScreen(key: args.key, project: args.project));
    }
  };
  ...
  List<_i8.RouteConfig> get routes => [
        ...
        _i8.RouteConfig(LogInRoute.name, path: '/admins/login'),
        _i8.RouteConfig(AddAdminRoute.name, path: '/admins/add'),
        _i8.RouteConfig(AddProjectRoute.name, path: '/projects/add'),
        _i8.RouteConfig(BulkUploadRoute.name, path: '/projects/bulkUpload'),
        _i8.RouteConfig(ProjectDetailsRoute.name, path: '/projects/:id'),
        _i8.RouteConfig(EditProjectRoute.name, path: '/edit-project-screen'),
...
/// generated route for
/// [_i3.AddAdminScreen]
class AddAdminRoute extends _i8.PageRouteInfo<void> {
...
class AddProjectRoute extends _i8.PageRouteInfo<void> {
...
class BulkUploadRoute extends _i8.PageRouteInfo<void> {
...
class ProjectDetailsRoute extends _i8.PageRouteInfo<ProjectDetailsRouteArgs> {
  ProjectDetailsRoute({_i9.Key? key, required int projectId})
...
/// generated route for
/// [_i7.EditProjectScreen]
class EditProjectRoute extends _i8.PageRouteInfo<EditProjectRouteArgs> {
  EditProjectRoute({_i9.Key? key, required _i10.Project project})
